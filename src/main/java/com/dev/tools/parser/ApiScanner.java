...
public class ApiScanner {
    private static final System.Logger LOGGER =
            System.getLogger(ApiScanner.class.getName());
    ...
    private final JavaParser javaParser = new JavaParser(config);
    ...
    /**
     * Scans all resolved Java source roots:<br>
    ...
    public void scanProject(String rootPath) throws Exception {
        ...
        List<Path> sourceRoots = resolveSourceRoots(rootDir);
    ...
    /**
     * Resolves the {@code src/main/java} directories to scan.
     *
     * <p>
     * If the root contains a {@code pom.xml} with {@code <module>} entries, this method
     * returns the source directories of those modules. Otherwise, it falls back to
     * {@code root/src/main/java}.
     * </p>
     *
     * @param root the project or workspace root directory
     * @return a list of Java source root directories
     * @throws Exception if the {@code pom.xml} file cannot be read
     */
    private List<Path> resolveSourceRoots(Path root) throws Exception {
    ...
    private void safeScanFile(Path path) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING, "Skipping invalid file: " +path+ ". Error: "+e.getMessage());
        }
    }
    ...
    private void writeDocumentationFiles(List<JsonBuilder> endpoints) throws Exception {
        ...
        LOGGER.log(System.Logger.Level.INFO,"Generating documentation files... "+ n);
        ...
        for (Map.Entry<String, List<JsonBuilder>> entry : endpointsByController.entrySet()) {
            ...
            try (PrintWriter writer = new PrintWriter(new FileWriter(file.toFile()))) {
                ...
                LOGGER.log(System.Logger.Level.INFO,"-> Generated " + file.getFileName());
            }
        }
    }
}